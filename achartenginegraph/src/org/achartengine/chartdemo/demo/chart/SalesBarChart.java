...
public class SalesBarChart extends AbstractDemoChart {
	...
	public Intent execute(Context context) {
		String[] titles = new String[] { "2007", "2008", "2009" };
		...
		values.add(new double[] { 14400, 12600, 15000, 12000, 15500, 18000,
				12030, 11200, 17500, 18500, 14600, 11000 });
		...
		setChartSettings(renderer, "Monthly sales in the last 2 years",
				"Month", "Units sold", 0.5, 12.5, 0, 34000, Color.GRAY,
				Color.LTGRAY);
